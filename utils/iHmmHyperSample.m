function [sbeta, salpha0, sgamma, N, M] = iHmmHyperSample(N, T, ibeta, ialpha0, igamma, hypers, numi)
% IHMMHYPERSAMPLE resamples the hyperparameters of an infinite hmm. 
%
% This code is taken from iHMM-v0.5__ written by Jurgen Van Gael, only
% modification is that N is precomputed
%
